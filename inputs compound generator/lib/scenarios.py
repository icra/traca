...
def trens_tractament_reals(configuracions_edars, edars_cabal, n_iteracions, limitacio_osmosi_inversa=True,
...
def all_scenarios(edars_escenaris, edars_calibrated_init, n_iteracions, escenaris_reals=True,
                  limitacio_osmosi_inversa=True, nomes_escenari_base=False):
