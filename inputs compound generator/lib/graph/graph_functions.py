...
def add_RT_lakes(river_graph: networkx.DiGraph, sorted_graph: object, RT_name: str) -> None:
    """
...
def graph_to_csv(river_graph: object, output_name: str = "") -> pandas.DataFrame:
    """
    ...
    if output_name == "":  # provides functionally random output name.
        output_name = time()
...
def run_model(river_graph, sorted_river_list, contamination_df, parameters, scenario='', output_field_name = '')\
        -> networkx.DiGraph:
    """
